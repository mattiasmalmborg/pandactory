...
export const SKILL_TREE: Record<SkillId, SkillNode> = {
  ...
  prod_1: {
    id: 'prod_1',
    name: 'Nimble Paws',
    description: 'Your paws remember the motions. +10% base production speed.',
    cost: 1,
    branch: 'production',
    tier: 1,
    requires: [],
  ...
  econ_1: {
    ...
    description: 'Negotiate with whom? The rocks? Yes. -10% building costs.',
    cost: 1,
    branch: 'economy',
    tier: 1,
    requires: [],
  ...
  cell_1: {
    id: 'cell_1',
    name: 'Gentle Touch',
    description: "You've learned to handle Power Cells without them exploding. Usually. +15% Power Cell effectiveness.",
    cost: 1,
    branch: 'power_cells',
    tier: 1,
    requires: [],
    effect: { type: 'power_cell_effectiveness', value: 0.15 },
  },
  cell_2: {
    id: 'cell_2',
    name: 'Cell Resonance',
